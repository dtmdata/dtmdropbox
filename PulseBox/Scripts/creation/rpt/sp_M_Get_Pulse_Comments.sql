create or replace PROCEDURE     sp_M_Get_Pulse_Comments (IN_company_id  IN number,
 						 IN_emp_id	IN number,
...
/*
--this is just the pulse texts from the emp_id himself:
